...
const ProductBoreholeLoggingProductList = props => {
...
export const query = graphql`
  query ProductBoreholeLoggingProductList($locale: String!) {
    allMarkdownRemark(
      filter: {
        fields: { locale: { eq: $locale } },
        fileAbsolutePath: { regex: "/products/borehole-logging-.*.md$/" }
      },
...
export default ProductBoreholeLoggingProductList;
