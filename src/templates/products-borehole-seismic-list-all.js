...
const ProductBoreholeSeismicProductList = props => {
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 mt-4 pt-2">
                <a href={'/kuyu-olcum-ve-analiz'}>← Geri dön</a>
              </div>
            </div>
          </div>
          <div className="container">
...
export const query = graphql`
  query ProductBoreholeSeismicProductList($locale: String!) {
    allMarkdownRemark(
      filter: {
        fields: { locale: { eq: $locale } },
        fileAbsolutePath: { regex: "/products/borehole-seismic-.*.md$/" }
      },
...
export default ProductBoreholeSeismicProductList;
