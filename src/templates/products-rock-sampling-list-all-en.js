...
const ProductRockSamplingEnProductList = props => {
...
export const query = graphql`
    query ProductListEn($locale: String!) {
        allMarkdownRemark(
            filter: {
                fields: { locale: { eq: $locale } },
                fileAbsolutePath: { regex: "/products/rock-sampling-.*.md$/" }
            },
...
export default ProductRockSamplingEnProductList;
